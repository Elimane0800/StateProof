> Ce fichier est le README d'origine du moteur (anciennement `TheCodeV2`), porté
> tel quel dans `feat/backend-ai` comme référence pour le portage vers `backend/`
> (voir [README.md](README.md) et [docs/BUILD_PLAN.md](docs/BUILD_PLAN.md)).
